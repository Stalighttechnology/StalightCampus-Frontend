...
const LoginMobile = ({ setRole, setPage, setUser }: LoginMobileProps) => {
  ...
  return (
    <div className="min-h-[100dvh] pt-[env(safe-area-inset-top,0px)] pb-[calc(env(safe-area-inset-bottom,0px)+16px)] overflow-x-hidden overflow-y-auto flex flex-col w-full bg-transparent relative">
      {/* HEADER */}
