    ...
    <>
      ...
      <div className={`w-full min-h-full ${theme === 'dark' ? 'bg-background text-foreground' : 'bg-gray-50 text-gray-900'}`}>
        ...
        <Dialog open={dialogOpen} onOpenChange={(open) => {
          ...
          <DialogContent className={`qp-dialog-content ${theme === 'dark' ? 'bg-card text-foreground border border-border' : 'bg-white text-gray-900 border border-gray-200'} max-w-4xl sm:max-w-5xl w-[95%] rounded-xl flex flex-col max-h-[90vh]`}>
