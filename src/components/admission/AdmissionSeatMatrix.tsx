  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold">Seat Matrix</h1>
        <Button disabled>
            ...
            return (
              <Card key={matrix.id}>
                <CardHeader className="flex flex-row items-center justify-between pb-2">
                  <CardTitle>{matrix.branch_name}</CardTitle>
                  <div className="flex gap-2">
                    <Button variant="ghost" size="icon" disabled><Edit size={16}/></Button>
                  </div>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-4 gap-4 mb-6">
                    <div className="p-4 bg-muted/30 rounded-lg text-center">
                      <p className="text-xs text-muted-foreground uppercase mb-1">Total Capacity</p>
                      <p className="text-2xl font-bold">{matrix.total_capacity}</p>
                    </div>
                    ...
                    <div className="p-4 bg-muted/30 rounded-lg text-center">
                      <p className="text-xs text-muted-foreground uppercase mb-1">Merit Quota</p>
                      <p className="text-xl font-bold">{matrix.merit_quota}</p>
                    </div>
                    <div className="p-4 bg-muted/30 rounded-lg text-center">
                      <p className="text-xs text-muted-foreground uppercase mb-1">Management Quota</p>
                      <p className="text-xl font-bold">{matrix.management_quota}</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="w-full bg-muted rounded-full h-2.5">
                      <div className="bg-primary h-2.5 rounded-full transition-all" style={{ width: `${fillPercentage}%` }}></div>
                    </div>
