  ...
  return (
    <div className="p-6 font-sans">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold text-foreground">Admission Dashboard</h1>
      </div>

      {newLeads > 0 && (
        <div className="mb-8 p-4 bg-primary/10 border border-primary/20 rounded-lg flex items-start gap-4">
          <AlertCircle className="w-6 h-6 text-primary flex-shrink-0 mt-0.5" />
          <div>
            <h3 className="text-primary font-semibold text-lg">Action Required: New Leads</h3>
            <p className="text-primary/80">You have <strong>{newLeads}</strong> new enquiries in your pipeline waiting to be contacted. Prompt responses increase conversion rates!</p>
          </div>
        </div>
      )}
      
      {/* HODStats Style Cards */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {[
          ...
          <div
            key={i}
            className="p-5 rounded-lg shadow-sm flex items-center gap-5 border bg-card border-border hover:shadow-md transition-shadow"
          >
            <div className={`flex items-center justify-center w-14 h-14 rounded-full flex-shrink-0 ${item.bgColor}`}>
              {item.icon}
            </div>
            <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="shadow-sm">
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">Distribution of students across stages</p>
          </CardHeader>
          <CardContent>
        ...
        <Card className="shadow-sm">
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">Number of enquiries per course</p>
          </CardHeader>
          <CardContent>
            <div className="h-[300px] w-full mt-2">
