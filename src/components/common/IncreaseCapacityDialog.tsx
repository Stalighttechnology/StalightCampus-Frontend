                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            <div className={`w-4 h-4 rounded-full border flex items-center justify-center ${isCurrentOrSmaller ? 'border-slate-300' : bufferSize === opt.size ? 'border-primary bg-primary' : 'border-slate-300'
                              }`}>
