...
interface DashboardLayoutProps {
  role: "admin" | "principal" | "hod" | "faculty" | "student" | "fees_manager" | "coe" | "dean" | "hms" | "warden" | "transport_admin" | "driver";
  user: User;
  activePage: string;
...
const DashboardLayout: React.FC<DashboardLayoutProps> = ({
  ...
  const isNoAnimation = role === 'admin' || role === 'principal' || role === 'hms' || role === 'warden' || role === 'transport_admin' || role === 'driver';
