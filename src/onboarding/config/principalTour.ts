...
export const principalTour: Step[] = [
  ...
  },
  {
    ...
    title: 'HOD Leaves',
    content: 'Review, approve, or reject leave applications submitted by Department Heads.',
    placement: 'right' as const,
    disableBeacon: false,
  ...
  },
  {
    ...
    content: 'Review and manage leave requests submitted by other administrative staff.',
    placement: 'right' as const,
    disableBeacon: false,
